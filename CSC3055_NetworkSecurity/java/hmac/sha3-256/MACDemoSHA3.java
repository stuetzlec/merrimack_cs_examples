 ...
 */
 ...
 /**
 * This file implements a simple MAC demo using SHA3.
 *
 * @author Zach Kissel
 */
 public class MACDemoSHA3 {
       ...
       InvalidKeyException
   {
    ...
    // Get a new HMAC instance.
     Mac hmac = Mac.getInstance("HMACSHA3-256");

     // Construct an key for the HMAC.
     KeyGenerator hmacKeyGen = KeyGenerator.getInstance("HMACSHA3-256");
