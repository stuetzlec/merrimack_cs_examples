 ...
 * @author Zach Kissel
 */
public class DiffieHellmanKEXServer {
      ...
      InvalidAlgorithmParameterException
  {
    ...
    while (true)
    {
      ...
      // Print the public value being sent.
      ...
      String toEcho = recv.nextLine();

      String ptext = doDecryption(rawKey, toEcho);
      System.out.println("Received: " + ptext);
      
      send.println(doEncryption(rawKey, ptext.toUpperCase()));
